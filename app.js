...
function render(){
 ...
 if(!list.length){$('#word').textContent='没有符合条件的単語';$('#backWord').textContent='';return}
...
$('#resetBtn').onclick=()=>{if(confirm('确定クリア所有学習记录吗？')){localStorage.removeItem('jhEnglishV2');location.reload()}};
